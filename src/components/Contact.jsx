          ...
          <p
            className={
              dark === false
                ...
                : "text-white lg:text-4xl py-3 italic font-semibold text-center pb-7 tracking-wider md:text-3xl text-2xl"
            }
          >
            Get in Touch !!
          </p>
              ...
              <p
                className={
                  dark === false
                    ...
                    : "text-white font-semibold text-lg md:text-xl lg:text-2xl italic tracking-wide"
                }
              >
                Name :{" "}
              </p>
              <input
                className={
                  dark == false
                    ...
                    : "border-black border-2 px-4 py-2 outline-0 rounded-md italic tracking-widest text-md lg:text-lg"
                }
                type="text"
              ...
              <input
                className={
                  dark === false
                    ...
                    : "outline outline-0 border-2 border-black py-2 px-4 rounded-md text-md text-md lg:text-lg italic tracking-widest"
                }
                type="email"
              ...
              <textarea
                className={
                  dark === false
                    ...
                    : "p-5 border-2 border-black outline outline-0 text-lg italic font-lighter text-gray-500 tracking-widest rounded-md overflow-auto"
                }
                cols="30"
                rows="8"
              ...
              <button
                className={
                  dark === false
                    ...
                    : "bg-white py-2 px-3 text-black rounded-md font-semibold text-lg lg:text-xl ml-2 mt-2 tracking-wider italic"
                }
              >
                Submit
              </button>
