      ...
      <section
        className={
          dark === false
            ...
            : "w-full min-h-screen pb-20 pt-28 bg-[#003153]"
        }
      >
          ...
          <section className="lg:w-6/12 mx-auto w-9/12 px-10 flex flex-col gap-5">
            <article className="flex flex-col gap-2">
              ...
              <input
                className={
                  dark === false
                    ? "border-[#6a1b9a] border-2 px-4 py-2 outline-0 rounded-md italic tracking-widest text-md lg:text-lg"
            ...
            <article className="flex flex-col gap-2">
              ...
              <input
                className={
                  dark === false
                    ? "outline outline-0 border-2 border-[#6a1b9a] py-2 px-4 rounded-md text-md text-md lg:text-lg italic tracking-widest"
            ...
            <article className="flex flex-col gap-2 ">
              ...
              <textarea
                className={
                  dark === false
                    ? "p-5 border-2 border-[#6a1b9a] outline outline-0 text-lg italic font-lighter text-gray-500 tracking-widest rounded-md overflow-auto"
