  ...
  return (
    <>
      <section
        className={
          dark === false
            ? "fixed w-full  flex justify-between items-center px-12 py-5 bg-[#9A4EAE] z-50 shadow-md"
          ...
          <ul className="flex flex-col">
            <li className="mb-1">
              <a
                ...
                className={
                  dark === false
                    ? "flex flex-row items-center justify-center bg-[#4B0082] p-2 ml-[-92px] hover:ml-[-10px] w-fit"
            ...
            <li className="mb-1">
              <a
                ...
                className={
                  dark === false
                    ? "flex flex-row  items-center justify-center bg-[#4B0082] p-2 w-fit ml-[-80px] hover:ml-[-10px]"
            ...
            <li className="mb-1">
              <a
                ...
                className={
                  dark === false
                    ? "flex flex-row  items-center justify-center bg-[#4B0082] p-2 w-fit ml-[-160px] hover:ml-[-10px]"
